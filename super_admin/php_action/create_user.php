...
VALUES ('$username','$firstname', '$lastname','$gender',$active,'$phone',now());";
 ...
 VALUES ('$username','$password',default);";
	 ...
	 VALUES ('$firstname', '$lastname','$phone', $active,'$category')"; 
	 
	 //create user rights
	 $sql_user_rights ="INSERT INTO `user_rights`(`username`, `category_name`) VALUES ('$username','Administrator');";
	 
	//create user company
	 $sql_user_company="INSERT INTO `users_company`(`username`, `company_name`) VALUES ('$username','$category')";
	 ...
	 //checking if username exists
		...
		$query_phone="SELECT contactid FROM contacts WHERE phone='$phone' AND company_name='$category'";
