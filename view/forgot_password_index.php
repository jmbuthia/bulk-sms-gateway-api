...
<div class="login-box">
  <div class="login-logo slide-text slide_style_left">
    ...
    <a data-animation="animated zoomInRight" href="#"><b>Forgot </b> Password</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="admin/forgot_password_controller.php" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
         ...
         <div>
            <a href=".?action=reset_code" class="small-box-footer">I have reset code <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Send code     
