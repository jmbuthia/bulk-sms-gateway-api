...
<head>
  ...
  <title>Ruemerc Solutions | Authentication</title>
...
<div class="login-box" style="opacity: 0.9;
  ...
  <div class="login-logo slide-text slide_style_left">
    <a data-animation="animated zoomInRight" href="#" style="color: white"><b>Ruemerc</b> | SMS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="." method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="ps" required placeholder="Password">
      ...
      <div class="row">
        <div class="col-xs-8">
         ...
         <div>
            <a href=".?action=forgot_password" class="small-box-footer">Forgot Password <i class="fa fa-arrow-circle-right"></i></a>
          </div>
